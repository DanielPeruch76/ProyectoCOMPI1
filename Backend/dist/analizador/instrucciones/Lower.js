...
class Lower extends Instruccion_1.Instruccion {
    ...
    interpretar(arbol, tabla) {
        ...
        if (this.cadena.tipoDato.getTipo() != Tipo_1.tipoDato.STRING) {
            return new Errores_1.default('SEMANTICO', 'No es un string el valor dado', this.linea, this.col);
        }
        this.tipoDato = this.cadena.tipoDato;
        return new Nativo_1.default(this.cadena.tipoDato, valor.toString().toLowerCase(), this.linea, this.col);
    }
}

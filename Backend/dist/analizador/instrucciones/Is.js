...
class Is extends Instruccion_1.Instruccion {
    constructor(cadena, tipo, linea, col) {
    ...
    interpretar(arbol, tabla) {
        ...
        if (this.cadena.tipoDato.getTipo() === this.tipo.getTipo()) {
            ...
            return new Nativo_1.default(new Tipo_1.default(Tipo_1.tipoDato.BOOL), true, this.linea, this.col);
        }
        this.tipoDato = new Tipo_1.default(Tipo_1.tipoDato.BOOL);
        return new Nativo_1.default(new Tipo_1.default(Tipo_1.tipoDato.BOOL), false, this.linea, this.col);
    }
}
exports.default = Is;

...
class ToString extends Instruccion_1.Instruccion {
    ...
    interpretar(arbol, tabla) {
        ...
        this.tipoDato = new Tipo_1.default(Tipo_1.tipoDato.STRING);
        return new Nativo_1.default(new Tipo_1.default(Tipo_1.tipoDato.STRING), valor.toString(), this.linea, this.col);
    }
}

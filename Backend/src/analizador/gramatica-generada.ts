...
export class ProyectoParser extends JisonParser implements JisonParserApi {
    ...
    defaultActions: {[key:number]: any} = {27:[2,64],28:[2,65],37:[2,112],38:[2,113],39:[2,1],111:[2,45],114:[2,24],115:[2,25],168:[2,76],195:[2,75],199:[2,32],248:[2,31],251:[2,42],255:[2,63],280:[2,53],281:[2,54],299:[2,27],310:[2,30],312:[2,28],319:[2,29]};
...
$$[$0-1].push($$[$0]); this.$ = $$[$0-1];
break;
case 3: case 34: case 37: case 40: case 56: case 72: case 80:
this.$ = [$$[$0]];
break;
case 4: case 5: case 6: case 7: case 8: case 9: case 11: case 12: case 13: case 14: case 21: case 22: case 35: case 91:
this.$ = $$[$0-1];
break;

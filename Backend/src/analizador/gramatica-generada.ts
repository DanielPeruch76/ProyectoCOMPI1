...
export class ProyectoParser extends JisonParser implements JisonParserApi {
    ...
    defaultActions: {[key:number]: any} = {27:[2,51],28:[2,52],37:[2,96],38:[2,97],39:[2,1],107:[2,24],108:[2,25],158:[2,63],181:[2,62],224:[2,33],226:[2,50],246:[2,41],247:[2,42],261:[2,27],267:[2,28]};
